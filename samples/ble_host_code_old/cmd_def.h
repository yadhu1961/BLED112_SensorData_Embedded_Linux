...
//Yadhu added for maintaining the state machine
...
extern const char *state_names[number_of_states];

//Function declarations

void change_state(states);
typedef void (*sighandler_t)(int);
extern int ready_to_update;
...
#define ble_cmd_connection_slave_latency_disable(disable) ble_send_message (ble_cmd_connection_slave_latency_disable_idx,disable)
...
/**Debug command**/
#define ble_cmd_test_debug(opcode,input_len,input_data) ble_send_message (ble_cmd_test_debug_idx,opcode,input_len,input_data)
