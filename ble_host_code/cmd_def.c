...
const char *state_names[number_of_states] = {
    "idle",
    "advertising",
    "connecting",
    "connected",
...
//{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_cmd|0x0,0x1,ble_cls_system,ble_cmd_system_reset_id} This is the header

/*
 *
 * (uint8)ble_dev_type_ble|(uint8)ble_msg_type_cmd|0x0,0x1,ble_cls_system,ble_cmd_system_reset_id} --> First four bytes of the packet
 *
 * (uint8)ble_dev_type_ble|(uint8)ble_msg_type_cmd|0x0 --> First byte of the packet.
 * */
...
static const struct ble_msg  apis[]={
	...
	{{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_cmd|0x0,0x1,ble_cls_connection,ble_cmd_connection_slave_latency_disable_id}, 0x2, (ble_cmd_handler)ble_default},
	...
	{{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_cmd|0x0,0x2,ble_cls_sm,ble_cmd_sm_set_pairing_distribution_keys_id}, 0x22, (ble_cmd_handler)ble_default},
	...
	{{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_cmd|0x0,0x4,ble_cls_gap,ble_cmd_gap_set_initiating_con_parameters_id}, 0x44, (ble_cmd_handler)ble_default},
	{{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_cmd|0x0,0x6,ble_cls_gap,ble_cmd_gap_set_nonresolvable_address_id}, 0xa, (ble_cmd_handler)ble_default},
	...
	{{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_cmd|0x0,0x1,ble_cls_hardware,ble_cmd_hardware_sleep_enable_id}, 0x2, (ble_cmd_handler)ble_default},
	...
	{{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_cmd|0x0,0x2,ble_cls_test,ble_cmd_test_debug_id}, 0x82, (ble_cmd_handler)ble_default},
	...
	{{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_rsp|0x0,0x2,ble_cls_connection,ble_cmd_connection_slave_latency_disable_id}, 0x4, 	(ble_cmd_handler)ble_rsp_connection_slave_latency_disable},
	...
	{{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_rsp|0x0,0x2,ble_cls_sm,ble_cmd_sm_set_pairing_distribution_keys_id}, 0x4, 	(ble_cmd_handler)ble_rsp_sm_set_pairing_distribution_keys},
	...
	{{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_rsp|0x0,0x2,ble_cls_gap,ble_cmd_gap_set_initiating_con_parameters_id}, 0x4, 	(ble_cmd_handler)ble_rsp_gap_set_initiating_con_parameters},
	{{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_rsp|0x0,0x2,ble_cls_gap,ble_cmd_gap_set_nonresolvable_address_id}, 0x4, 	(ble_cmd_handler)ble_rsp_gap_set_nonresolvable_address},
	...
	{{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_rsp|0x0,0x2,ble_cls_hardware,ble_cmd_hardware_sleep_enable_id}, 0x4, 	(ble_cmd_handler)ble_rsp_hardware_sleep_enable},
	...
	{{(uint8)ble_dev_type_ble|(uint8)ble_msg_type_rsp|0x0,0x2,ble_cls_test,ble_cmd_test_debug_id}, 0x82, 	(ble_cmd_handler)ble_rsp_test_debug},
...
{
    const struct ble_msg *msg=&apis[sizeof(apis)/sizeof(struct ble_msg )-1];
...
static const struct ble_msg* const ble_class_connection_rsp_handlers[]=
{
	...
	&apis[ble_rsp_connection_slave_latency_disable_idx],
};
...
static const struct ble_msg* const ble_class_sm_rsp_handlers[]=
{
	...
	&apis[ble_rsp_sm_set_pairing_distribution_keys_idx],
};
...
static const struct ble_msg* const ble_class_gap_rsp_handlers[]=
{
	...
	&apis[ble_rsp_gap_set_initiating_con_parameters_idx],
	&apis[ble_rsp_gap_set_nonresolvable_address_idx],
};
...
static const struct ble_msg* const ble_class_hardware_rsp_handlers[]=
{
	...
	&apis[ble_rsp_hardware_sleep_enable_idx],
};
...
const struct ble_class_handler_t ble_class_rsp_handlers[ble_cls_last]=
{
	...
	{ble_class_connection_rsp_handlers,10},
	{ble_class_attclient_rsp_handlers,12},
	{ble_class_sm_rsp_handlers,9},
	{ble_class_gap_rsp_handlers,13},
	{ble_class_hardware_rsp_handlers,22},
